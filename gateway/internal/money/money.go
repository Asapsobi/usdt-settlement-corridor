// Package money is C6's minimal money primitive, mirroring every prior
...
// BEP20 and TRC20). Duplicated, not shared -- separate Go modules, no
// common internal package between them, the same convention this whole
