...
// Like C2.10's own Config, this is a seed plus where to find that
// running C1, not a scenario-count mix -- C3's own real-world volume is
// ~100 screenings/day (component-map.md), and this chunk's own
// PERFORMANCE TARGET is explicit that correctness under adversarial
// conditions is the point, not throughput.
type Config struct {
	Seed          int64
